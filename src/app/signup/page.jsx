      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <div className="auth-header">
            ...
            <p className="auth-subtitle">팡클리닉 회원이 되어보세요</p>
          </div>
          ...
          <div className="auth-social">
            <button className="social-btn" onClick={() => alert('Google 회원가입')}>
